...
class SumPooling(text_problems.Text2ClassProblem):

    ROOT_DATA_PATH = '../data_manager/'
    PROBLEM_NAME = 'sum_pooling_feature'
    ...
    def generate_samples(self, data_dir, tmp_dir, dataset_split):
        ...
        with open('../prep_data/antecedent_label.txt') as antecedent_label, open(
                '../prep_data/input_vec_sum_feature.txt') as input_vec:
...
# PROBLEM_NAME='sum_pooling_feature'
# DATA_DIR='../train_data_sum_feature'
# OUTPUT_DIR='../output_sum_feature'
